...
exports.create = {
    ...
    process: function (bot, msg, suffix) {
	    ...
	    if (msg.channel.guild.id == 602544926051270676) {channel.edit({parent: "602901288119697408"});channel.edit({permissionOverwrites:channel.parent.permissionOverwrites});}
